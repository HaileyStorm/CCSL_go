...
// ResizeMaintain resizes img while maintaining its aspect ratio and ensuring that the new image fills the desired size.
...
// ResizeMaintainWithInterp resizes img while maintaining its aspect ratio and ensuring that the new image fills the desired size.
// The source image will be cut off in the smaller target dimension if they are not the same aspect ratio.
// The upper-left corners are aligned.
